...
interface OlympusBondDepositoryV2Interface extends ethers.utils.Interface {
  functions: {
    ...
    "initialize_FrontEndRewarder(address,address)": FunctionFragment;
    "initialize_NoteKeeper(address,address,address,address,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "initialize_FrontEndRewarder",
    values: [string, string]
  ): string;
  encodeFunctionData(
    functionFragment: "initialize_NoteKeeper",
...
export class OlympusBondDepositoryV2 extends BaseContract {
  ...
  interface: OlympusBondDepositoryV2Interface;
  ...
  functions: {
    ...
    initialize_FrontEndRewarder(
      _authority: string,
      _ohm: string,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;

    initialize_NoteKeeper(
      _authority: string,
      _ohm: string,
      _gohm: string,
      _staking: string,
