...
import type { TypedEventFilter, TypedEvent, TypedListener } from "../STAKE/common";
...
interface SOlympusInterface extends ethers.utils.Interface {
  functions: {
    ...
    "finalizeSetup(address,address)": FunctionFragment;
    ...
    "initialize_ERC20Permit(string)": FunctionFragment;
    "initialize_sOlympus(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "finalizeSetup",
    values: [string, string]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "initialize_sOlympus",
    values: [string]
  ): string;
